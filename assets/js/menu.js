const CHAPTERS = {
  'chapter-1': {
    number: 'Chapitre 1',
    name: 'Polynômes du second degré',
  ...
  'chapter-2': {
    ...
    sections: [
      ...
      { id: 'section-09', number: 'Section 9', title: 'Aires des lfigures planes' },
      { id: 'section-10', number: 'Section 10', title: 'Périmètres et ongueurs' },
